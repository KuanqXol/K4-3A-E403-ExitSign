...
| U2 - Hoàng Trung Hiếu, willing user CP1, mới học Applied AI system | Bấm xin gợi ý Socratic cho câu hỏi đang chờ, sau đó chọn đáp án và đọc phản hồi | Gợi ý không lộ đáp án, nhưng người thử muốn biết gợi ý liên quan trực tiếp đến khái niệm nào | "Gợi ý ổn vì không nói đáp án, nhưng mình muốn biết nó đang gợi ý phần Context Window hay Attention." | Đã bổ sung Concept Badge (🏷️ Khái niệm) cùng mức độ khó nổi bật trên khung câu hỏi và phản hồi AI, giúp người học nhận biết ngay phạm vi kiến thức đang được dẫn dắt. |
...
| U5 - Trần Khánh Linh, sinh viên ngoài nhóm | Làm bài kéo thả Temperature, sau đó hỏi "giải thích cái này" khi không có câu hỏi chờ | Người thử kỳ vọng hệ thống tự biết "cái này" là slide đang mở; hiện hệ thống hỏi lại để làm rõ | "Mình đang ở slide Temperature nên khi gõ cái này mình nghĩ nó hiểu là cái slide này." | Đã hiện thực hóa tính năng Contextual Slide Grounding: đính kèm `slide_concept` từ slide đang mở vào request; khi học viên hỏi cộc lốc/mơ hồ ("giải thích cái này"), engine tự động bám ngữ cảnh slide đó để giải thích trúng đích thay vì hỏi lại làm loãng phiên học. |

## Tổng kết 4 dòng

- Chủ đề lặp nhiều nhất: người thử cần nhãn hành động rõ ràng và kỳ vọng AI tự nhận biết ngữ cảnh slide đang mở khi đặt câu hỏi ngắn gọn.
- Sẽ sửa gì trước demo: (1) Sửa copy và nhãn nút "Tạo câu hỏi AI đầu tiên" (U1); (2) Bổ sung Concept Badge nổi bật trên thẻ AI (U2); (3) Tự động truyền ngữ cảnh slide đang mở (`slide_concept`) để AI giải thích trúng đích khi học viên hỏi mơ hồ (U5).
- Giữ nguyên gì và vì sao: giữ Socratic hint không lộ đáp án và guard từ chối ngoài phạm vi (U4) vì đây là các ràng buộc an toàn/pedagogy bắt buộc đã chốt ở §7.
- Để dành sau: rút gọn thông báo ngoài phạm vi và tinh chỉnh hiệu ứng viền hover cho toàn khối bắt lỗi.
